            ...
            <div className="flex-grow">
              <nav>
                <ul className="space-y-3">
                  {/* Regular links (Dashboard and Profile) */}
                  {links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                  ...
                  {/* Exam Prep link (added after Academics) */}
                  <li>
                    <Link
                      href={examPrepItem.href}
                      className={`flex items-center ${
                        isSidebarExpanded
                          ? "justify-start mx-3"
                          : "justify-center"
                      } p-3 rounded-md ${
                        pathname === examPrepItem.href
                          ? "bg-blue-500"
                          : "hover:bg-gray-700"
                      }`}
                      title={!isSidebarExpanded ? examPrepItem.name : ""}
                    >
                      <span>{examPrepItem.icon}</span>
                      {isSidebarExpanded && (
          ...
          <nav>
            <ul className="flex justify-around items-center p-3">
              ...
              <li className="relative">
                ...
                {showMiniDropdown && (
                  <div
                    className="absolute bottom-full left-0 right-0 mb-2 mx-auto bg-gray-800 rounded-md shadow-lg border border-gray-700 w-48 z-50"
